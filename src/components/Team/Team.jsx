        ...
        <section id='team' className='section'>
            <div className='container mx-auto text-center'>
                ...
                <p className='max-w-[540px] mx-auto px-6 lg:px-0 mb-[60px]'>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Mollitia qui dolorum omnis quo. Cum dolores quis non fugiat repellendus placeat.
                </p>
                    ...
                    {team.map((item, index) => {
                        ...
                        return (
                            <div className='text-center lg:text-left mb-12' key={index}>
                                <img className='mx-auto lg:mx-0 mb-6' src={image} alt='image' />
